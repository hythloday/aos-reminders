    ...
    effects: [
      {
        ...
        when: [HERO_PHASE],
        rule_sources: [rule_sources.BATTLETOME_SPOOKYBAT_GROANLADS, rule_sources.ERRATA_AUGUST_2021],
      },
    ],
  },
  'Amaranthine Orb': {
    ...
    effects: [
      {
        ...
        when: [HERO_PHASE],
        rule_sources: [rule_sources.BATTLETOME_SPOOKYBAT_GROANLADS, rule_sources.ERRATA_OCTOBER_2022],
      },
    ],
  },
  'Prison of Grief': {
